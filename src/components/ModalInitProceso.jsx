...
const ModalInitProceso = () => {
  ...
  return (
    <Transition.Root show={modalInitProcedimiento} as={Fragment}>
      <Dialog
        as="div"
        className="fixed z-10 inset-0 overflow-y-auto"
        onClose={handleModalIniciarProceso}
      >
            ...
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
              <div className="hidden sm:block absolute top-0 right-0 pt-4 pr-4">
                <button
                  ...
                  onClick={handleModalIniciarProceso}
                >
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Está a punto de iniciar: {proceso.titulo}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                <button
                  ...
                  onClick={() => inicioProcedimiento(proceso.id)}
                >
                  Iniciar
                </button>
                <button
...
export default ModalInitProceso;
